...
Напоминания сохраняются в `reminders.json`. Список напоминаний общий: оба разрешенных пользователя видят одни и те же активные напоминания и могут удалить их по ID.
